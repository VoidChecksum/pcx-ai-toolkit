...
Native reverse-engineering tools live in [`../tools/pe-parser/`](../tools/pe-parser/) and are built into `../tools/bin/` by setup, update, and CI. The stable user-facing commands remain the Python wrappers: [`../tools/sig-uniqueness-checker.py`](../tools/sig-uniqueness-checker.py), [`../tools/binary-diff-summary.py`](../tools/binary-diff-summary.py), and [`../tools/offset-diff.py`](../tools/offset-diff.py). If Cargo is unavailable, the wrappers fall back to Python implementations.
