...
Three surfaces let AI tools reach the toolkit's corpus efficiently. Start with [`perception/llm-routing.md`](perception/llm-routing.md) / `docs/perception/llm-routing.md` so the model chooses the correct Enma or AngelScript binding before using API names. Pick by integration model; see [`.claude/skills/pcx-knowledge-index/SKILL.md`](../.claude/skills/pcx-knowledge-index/SKILL.md) for the decision tree.
