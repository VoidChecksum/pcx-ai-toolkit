...
CATEGORIES = [
    ...
    ('docs/lua/**/*.md',               'Lua Language Docs',      'Current Perception Lua scripting surface: lifecycle, examples, and PCX API usage.'),
...
LANG_BUNDLES = {
    ...
    'angelscript': {
        ...
        'desc': 'Single-file context pack for AI tools writing current Perception AngelScript `.as` scripts while Enma AOT is unreleased.',
        'globs': [
            'docs/perception/llm-routing.md',
            'docs/angelscript/**/*.md',
            '.claude/skills/game-cheat-guidelines/SKILL.md',
            ...
            '.claude/skills/pcx-patch-day-playbook/SKILL.md',
            '.claude/skills/re-evidence-log/SKILL.md',
            'knowledge/angelscript-cheatsheet.md',
            'knowledge/aimbot-math.md',
            'knowledge/offset-methodology.md',
        ],
    },
    'lua': {
        ...
        'desc': 'Single-file context pack for AI tools writing current Perception Lua `.lua` scripts.',
        'globs': [
            'docs/perception/llm-routing.md',
            'docs/lua/**/*.md',
            '.claude/skills/game-cheat-guidelines/SKILL.md',
