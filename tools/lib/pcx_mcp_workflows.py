...
EXTRA={
 "module_inventory":(("module","inventory","modules","map"),"Inventory process modules",["process/reference_by_name","process/get_modules","process/list_module_exports","process/dereference"]),
 ...
 "import_export_analysis":(("import","export","iat","eat"),"Analyze imports and exports",["process/reference_by_name","process/get_module_by_name","process/list_module_exports","process/get_module_imports","process/dereference"]),
