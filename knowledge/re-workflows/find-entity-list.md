...
## Claim
Prove the address or offset for `entity-list root` for this exact build.

## Required evidence
- module version/hash, entity list string/export/schema name, unique signature or xref chain, live memory validation, pointer-chain validation, negative candidates ruled out
