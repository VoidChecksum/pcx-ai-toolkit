...
## Claim
Prove the address or offset for `vtable method slot` for this exact build.

## Required evidence
- module version/hash, RTTI/type name, vtable address, slot function bounds, callsite/xref proof
