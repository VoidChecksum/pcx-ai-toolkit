...
## Claim
Prove the address or offset for `bone array pointer` for this exact build.

## Required evidence
- module version/hash, skeleton/bone string, model/animation owner, valid pointer array, bone count/range checks
