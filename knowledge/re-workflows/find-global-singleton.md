# Find Global Singleton

## Claim
Prove the address or offset for `global singleton address` for this exact build.

## Required evidence
- module version/hash, singleton string/export, RIP-relative target, valid object header/vtable, duplicate globals rejected
