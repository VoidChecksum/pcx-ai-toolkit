...
## Claim
Prove the address or offset for `active camera pointer` for this exact build.

## Required evidence
- module version/hash, camera string/export, unique xref, FOV/position typed reads, menu/spectator false cameras rejected
