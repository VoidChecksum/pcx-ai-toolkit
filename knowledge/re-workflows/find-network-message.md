# Find Network Message

## Claim
Prove the address or offset for `network message handler` for this exact build.

## Required evidence
- module version/hash, message name/id string, dispatch xref, function bounds, packet shape validation
