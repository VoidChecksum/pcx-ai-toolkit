...
## Claim
Prove the address or offset for `health field offset` for this exact build.

## Required evidence
- module version/hash, health/UI string, owner class/function, typed read changes with damage/heal, nearby false fields rejected
