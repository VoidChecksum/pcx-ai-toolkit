...
## Claim
Prove the address or offset for `local player pointer` for this exact build.

## Required evidence
- module version/hash, player/controller string, unique xref chain, valid pawn/controller pointer, negative singleton candidates
